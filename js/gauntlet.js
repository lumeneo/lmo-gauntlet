Gauntlet = function() {
  ...
  var Player = Class.create({
    ...
    collect: function(treasure) {
      console.log("scored! here is your LMO treasure..."+treasure.type.score);
      lmoConsoleCall("scored! here is your LMO treasure..."+treasure.type.score);
      creditsEarned += treasure.type.score;
      console.log("Player total earnings are... "+creditsEarned);
  ...
  var Scoreboard = Class.create({
    ...
    onStartLevel: function(map) {
      console.log("starting a level if player has money: "+canPlay);
